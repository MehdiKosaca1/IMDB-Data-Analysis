...
```{r}
library(readxl)
dosya_yolu <- "C:\\Users\\mehdi\\Downloads\\data22.xlsx"
...
Bu sayede "IMDBPuan" ile "MetaPuan" arasındaki fark "PuanFarki" adlı türetilmiş yeni bir değişkene yazdırdık.
...
-   **MetaPuan ve Süre:** Aralarında belirgin bir ilişki yok, yani filmlerin süresi Metapuanı etkilemiyor.

-   **MetaPuan ve Çıkış Yılı:** Belirgin bir ilişki yok, yani filmlerin çıkış yılı Metapuanı etkilemiyor.
...
Bu korelasyon matrisi, film veri setindeki değişkenler arasındaki ilişkiler hakkında önemli bilgiler sağlar. Özellikle, IMDb ve Meta puanları arasındaki güçlü pozitif korelasyon, bu iki puan türünün benzer ölçütler olduğunu gösterir.
...
Özetle, 'Tur' değişkeninin, 'Hasilat' değişkenine göre daha çeşitli olduğu söylenebilir.
